// ย่อรูปใบเสร็จก่อนอัปโหลด: ด้านยาวไม่เกิน 1480px, JPEG คุณภาพ 0.8 (~150-300KB ต่อรูป) - ตัวหนังสือยังอ่านชัด
// รูปจากกล้องมือถือ (3-8MB) จึงอัปโหลดเร็วและเปลืองที่เก็บน้อย. หมุนรูปตาม EXIF ให้ตั้งตรงก่อนย่อ
// 1480 = ขนาดเดียวกับรูปจาก LINE (1108x1477 ≈ 2,180 image token) ที่ทดสอบความแม่นของ AI ไว้กับใบเสร็จจริง 34 ใบ
// ค่า AI คิดตามจำนวนพิกเซล ไม่ใช่ขนาดไฟล์: ใหญ่กว่านี้จ่ายแพงขึ้นโดยไม่แม่นขึ้น, เล็กลงถึง 1000px อ่านพยัญชนะทะเบียนผิด (วัดแล้ว)
const MAX_EDGE = 1480;
