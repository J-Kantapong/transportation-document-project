...
- Preserve the Thai labels, navigation, 7 customer fields, 14 vehicle-entry fields (the original 12 plus `ประเภทเจ้าของรถ` and `ไฟแนนซ์`, added 2026-09-22), 77-province list, and the 13 unique vehicle-type choices unless the user changes them.
